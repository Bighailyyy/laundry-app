...
<div class="d-flex align-items-center gap-3 mb-4">
    ...
    <div>
        <h4 class="fw-bold mb-0">Tambah Layanan Baru</h4>
    ...
    <div class="card-body p-4">
        <form action="{{ route('layanan.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="harga_per_kg" class="form-control @error('harga_per_kg') is-invalid @enderror" value="{{ old('harga_per_kg') }}" min="1000" required>
                @error('harga_per_kg')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            <div class="mb-4">
                <label class="form-label fw-semibold">Deskripsi</label>
                <input type="text" name="deskripsi" class="form-control" value="{{ old('deskripsi') }}" placeholder="Opsional">
            </div>
